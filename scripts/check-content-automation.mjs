...
if (existsSync(todayActions)) {
  ...
  for (const marker of ["Grant Labs Today Actions", "Today Queue", "Overdue Carryover", "Overdue Priority", "Overdue Summary", "Source Files", "Ready Copy", "Platform Execution Notes", "Operator Posting Checklist", "Tracked URL", "output/platform-ready-copy/", "Reporting Log", "npm run content:today", "consultation-checklist-conversion"]) {
