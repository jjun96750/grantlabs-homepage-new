...
if (existsSync("scripts/check-local-preview.mjs")) {
  ...
  for (const marker of ["http://127.0.0.1:4173", "/styles/homepage.css", "/__missing-local-preview__", "content-security-policy", "x-frame-options", "htmlIntegrityMarkers", lucideIntegrity, emailJsIntegrity, "Local preview check passed"]) {
