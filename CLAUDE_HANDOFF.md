...
- `scripts/check-local-preview.mjs` verifies local preview status codes, content types, homepage CDN script integrity markers, missing-route handling, and security headers including HSTS.
