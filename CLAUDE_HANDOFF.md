...
- Main branch: `main`
- Latest pushed commit at handoff update: `a8c17ff Validate external new-window links`
...
- `scripts/check-static-site.mjs` verifies required files, metadata, JSON-LD, docs markers, local `href` / `src` targets, cross-page hashes, and external new-window link safety.
