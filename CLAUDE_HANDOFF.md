...
- Main branch: `main`
- Latest implementation commit captured in this handoff: `9e21c9f Check HEAD responses in local preview`
...
- `scripts/check-local-preview.mjs` verifies local preview GET and HEAD status codes, content types, homepage CDN script integrity markers, missing-route handling, and security headers including HSTS.
